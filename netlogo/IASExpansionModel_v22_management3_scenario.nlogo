...
;  plot-size-distribution         ;; histogram of the distribution of the IAS'size (based on surface)
  ...
  set cut-management gis:load-dataset "C:/Users/claud/Downloads/UCO_contrato/Proyecto/02_ABM_Capitulo2/02_ABM_Capitulo2/abm_prep/recorte_400m.shp"
  ask patches [
